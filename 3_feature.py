...
# Generate learner-like classroom utterances based on the following approximate learner feature distribution:
...
# [error]
# Utterances containing lexical or grammatical errors typical of Korean language learners, including incorrect particles, verb endings, word choice, unnatural sentence structure, omission, addition, substitution, or incorrect word forms.

# [hesitation]
# Utterances containing hesitation markers or pauses such as “음…”, “어…”, or repeated starts.

# [trunc_word]
# Utterances containing repetitions, self-interruptions, or restarted words and phrases.

# [etc]
# Utterances containing pronunciation-related deviations, non-existent or unintelligible words, unfinished sentences or phrases, or the use of the speaker’s first language (L1).

# [none]
# A complete and fluent utterance without noticeable learner-like errors.
